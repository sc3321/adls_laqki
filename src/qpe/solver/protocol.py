...
class SolverFactory:
    ...
    The Pipeline Orchestrator receives a QuantizationSolver (the protocol) and never imports concrete implementations directly
    -> Adding a new solver requires only: 
